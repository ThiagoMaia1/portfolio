...
const translation : Record<string, Sentences> = {
    ...
    'en': {
        ...
        cultueDescription: 'Web application directed at the creation of slide presentations for churches. Uses Vagalume and Bible apis to fetch music lyrics and biblical texts and distribute them in the correct number of slides.',
        bibleForHumansTitle: 'Bible For Humans',
        bibleForHumansSubtitle : 'API Rest',
        bibleForHumansDescription: 'A restful API built on Node.JS, that receives biblical references in a way written by humans. Allows end users to write bible references in a non-rigid.',
