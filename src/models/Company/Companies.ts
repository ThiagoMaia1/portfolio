...
const companies = {
    ...
    ufvTutor: new Company('Universidade Federal de Viçosa', 'ufv.png', 'https://drive.google.com/file/d/1xexHKVkEbPjt9yVbi9Qmr3LgISoH5lJK/view?usp=sharing', 20),
    ...
    doBusiness: new Company('Do Business - English School', 'doBusiness.png', 'https://www.facebook.com/Do-Business-Language-School-119981734847291/', 30),
