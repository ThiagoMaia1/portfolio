...
export type TechnologyFamilies =
  | 'Vanilla'
  | 'React'
  | 'ReactNative'
  | 'Mobile'
...
const technologies = {
  ...
  AdobeIllustrator: new Technology(
    'Adobe Illustrator',
  ...
  AdobeLightroom: new Technology(
    'Adobe Lightroom',
    'AdobeLightroom.png',
    Category.Software,
    'https://www.adobe.com/br/products/photoshop-lightroom.html',
    'Adobe',
  ),
  AdobePremiere: new Technology(
    'Adobe Premiere',
    'AdobePremiere.png',
    Category.Software,
    'https://www.adobe.com/br/products/premiere.html',
    'Adobe',
  ),
  AdobePhotoshop: new Technology(
    'Adobe Photoshop',
    'AdobePhotoshop.png',
    Category.Software,
  ...
  ChromeExtensions: new Technology(
    'Chrome Extensions',
  ...
  PlayStore: new Technology(
    'Android Play Store',
    'PlayStore.svg',
    Category.Tool,
    'https://developer.android.com/distribute/console?hl=pt-br',
    'Mobile',
  ),
  ...
  StyledComponents: new Technology(
    'Styled Components',
...
const Vanilla = [t.Javascript, t.HTML5, t.Typescript, t.CSS3, t.SASS]
const Adobe = [
  t.AdobePhotoshop,
  t.AdobeIndesign,
  t.AdobeIllustrator,
...
const Cloud = [t.Firebase, t.AWS, t.Serverless, t.Azure, t.Sendgrid]
const ReactNative = [t.ReactNative, t.Expo, t.Redux]
const Flutter = [t.Flutter, t.Dart]

export const technologyFamilies: Record<
  TechnologyFamilies,
  Array<Technology>
> = {
  Vanilla,
