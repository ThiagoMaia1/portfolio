...
class ProfessionalExperience {
  ...
  get finalDate() {
    ...
    const month =
      this.initialDate.getMonth() + this.durationInMonths - wholeYears * 12 - 1
    return new Date(year, month, 1, 0, 0, 0)
  }

  static companyExperiences = (
    ...
    experiences
      .filter(
        (e) => e.companyKey === companyKey && e.isEducation === isEducation,
      )
      .sort((a, b) => b.initialDate.getTime() - a.initialDate.getTime())

  static filterByTechnology = (
    experiences: ProfessionalExperience[],
    technologyFilter: (technologyArray: Technology[]) => boolean,
  ) =>
