...
const professionalExperiences : ProfessionalExperience[] = [
    ...
    new ProfessionalExperience('reactAndNodeDeveloper', 'flomatika', 2021, 6, undefined, [t.ReactJs, t.Typescript, t.CSS3, t.MaterialUI, t.Jest, t.Storybook, t.SWR, t.NodeJs, t.Sequelize, t.PostgreSQL, t.Serverless, t.AWS, t.GitLab, t.Scrum, t.Jira, t.ForeignLanguage], true),
];
